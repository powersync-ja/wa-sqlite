...
function findWasmBinary() {
  ...
  return new URL("mc-wa-sqlite-async.wasm", import.meta.url).href;
}
...
var wasmImports = {
  ...
  /** @export */ ipp: _ipp,
  /** @export */ ipp_async: _ipp_async,
  /** @export */ ippipppp: _ippipppp,
  /** @export */ ippipppp_async: _ippipppp_async,
  /** @export */ ippp: _ippp,
  /** @export */ ippp_async: _ippp_async,
  /** @export */ ipppi: _ipppi,
  /** @export */ ipppi_async: _ipppi_async,
  /** @export */ ipppiii: _ipppiii,
  /** @export */ ipppiii_async: _ipppiii_async,
  /** @export */ ipppiiip: _ipppiiip,
  /** @export */ ipppiiip_async: _ipppiiip_async,
  /** @export */ ipppip: _ipppip,
  /** @export */ ipppip_async: _ipppip_async,
  /** @export */ ipppj: _ipppj,
  /** @export */ ipppj_async: _ipppj_async,
  /** @export */ ipppp: _ipppp,
  /** @export */ ipppp_async: _ipppp_async,
  /** @export */ ippppi: _ippppi,
  /** @export */ ippppi_async: _ippppi_async,
  /** @export */ ippppij: _ippppij,
  /** @export */ ippppij_async: _ippppij_async,
  /** @export */ ippppip: _ippppip,
  /** @export */ ippppip_async: _ippppip_async,
  /** @export */ ipppppip: _ipppppip,
  /** @export */ ipppppip_async: _ipppppip_async,
  /** @export */ random_get: _random_get,
  /** @export */ segfault,
  /** @export */ vppippii: _vppippii,
  /** @export */ vppippii_async: _vppippii_async,
  /** @export */ vppp: _vppp,
  /** @export */ vppp_async: _vppp_async,
  /** @export */ vpppip: _vpppip,
  /** @export */ vpppip_async: _vpppip_async
};
...
var _powersync_init_static = Module["_powersync_init_static"] = createExportWrapper("powersync_init_static", 0);
...
var _sqlite3_load_extension = Module["_sqlite3_load_extension"] = createExportWrapper("sqlite3_load_extension", 4);

var _sqlite3_enable_load_extension = Module["_sqlite3_enable_load_extension"] = createExportWrapper("sqlite3_enable_load_extension", 2);
...
var _sqlite3mc_config = Module["_sqlite3mc_config"] = createExportWrapper("sqlite3mc_config", 3);

var _sqlite3mc_cipher_count = Module["_sqlite3mc_cipher_count"] = createExportWrapper("sqlite3mc_cipher_count", 0);

var _sqlite3mc_cipher_index = Module["_sqlite3mc_cipher_index"] = createExportWrapper("sqlite3mc_cipher_index", 1);

var _sqlite3mc_cipher_name = Module["_sqlite3mc_cipher_name"] = createExportWrapper("sqlite3mc_cipher_name", 1);

var _sqlite3mc_config_cipher = Module["_sqlite3mc_config_cipher"] = createExportWrapper("sqlite3mc_config_cipher", 4);
...
var _sqlite3_version = Module["_sqlite3_version"] = 87792;
